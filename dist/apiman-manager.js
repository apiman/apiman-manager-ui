...
(function (Apiman) {
    ...
    Apiman._module.controller("Apiman.QuotaFormController", ['$scope', 'Logger', function ($scope, Logger) {
        var validate = function (config) {
            var valid = true;
            if (config.limit) {
                config.limit = Number(config.limit);
    ...
    Apiman._module.controller("Apiman.TransferQuotaFormController", ['$scope', 'Logger', function ($scope, Logger) {
    ...
    Apiman._module.controller("Apiman.CachingFormController", ['$scope', 'Logger', function ($scope, Logger) {
        var validate = function (config) {
            var valid = false;
            if (config.ttl) {
    ...
    Apiman._module.controller("Apiman.URLRewritingFormController", ['$scope', 'Logger', function ($scope, Logger) {
        var validate = function (config) {
            var valid = true;
            if (!config.fromRegex) {
                valid = false;
...
var Apiman;
(function (Apiman) {
    Apiman.AppMetricsController = Apiman._module.controller("Apiman.AppMetricsController", ['$q', '$scope', '$location', 'PageLifecycle', 'AppEntityLoader', '$routeParams', 'MetricsSvcs', function ($q, $scope, $location, PageLifecycle, AppEntityLoader, $routeParams, MetricsSvcs) {
        var params = $routeParams;
        $scope.organizationId = params.org;
        $scope.tab = 'metrics';
        $scope.version = params.version;
